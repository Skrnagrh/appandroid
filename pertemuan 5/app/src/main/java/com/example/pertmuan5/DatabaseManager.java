...
public class DatabaseManager {
    ...
    private static final String ROW_MADE = "made";
    ...
    private static final String CREATE_TABLE = "create table "
            ...
            + ROW_NAMA+ " text," + ROW_HARGA + " text," + ROW_MADE + " text)";
    ...
    public void addRow(String nama, String harga, String made) {

        ContentValues values = new ContentValues();
        values.put(ROW_NAMA, nama);
        values.put(ROW_HARGA, harga);
        values.put(ROW_MADE, made);
    ...
    public ArrayList<ArrayList<Object>> ambilSemuaBaris() {
        ...
        try {
            cur = db.query(NAMA_TABEL, new String[] { ROW_ID, ROW_NAMA,
                    ROW_HARGA, ROW_MADE }, null, null, null, null, null);
            cur.moveToFirst();
            if (!cur.isAfterLast()) {
                do {
    ...
    public ArrayList<Object> ambilBaris(long rowId) {
        ...
        try {
            cursor = db.query(NAMA_TABEL, new String[] { ROW_ID,
                            ROW_NAMA,ROW_HARGA,ROW_MADE }, ROW_ID + "=" + rowId, null, null, null,
                    null,null);
            cursor.moveToFirst();
    ...
    public void updateBaris(long rowId, String nama, String harga, String made) {

        ContentValues cv = new ContentValues();
        cv.put(ROW_NAMA, nama);
        cv.put(ROW_HARGA, harga);
        cv.put(ROW_MADE, made);
